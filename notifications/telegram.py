...
I18N = {
    "zh": {
        ...
        "deferred_buy_batch": "ℹ️ [买入跳过] {details}",
        "deferred_sell_batch": "ℹ️ [卖出跳过] {details}",
        "failed_buy_batch": "❌ [买入失败] {details}",
        "failed_sell_batch": "❌ [卖出失败] {details}",
        "skip_reason_quantity_zero": "整数股不足 1 股，无需下单",
        "skip_reason_min_notional": "低于最小订单金额",
        "skip_reason_missing_price": "缺少有效报价",
        "skip_reason_submit_failed": "提交失败",
        "skip_reason_below_trade_threshold": "低于调仓阈值",
        "skip_reason_unknown": "未知原因",
        "skip_reason_cancelled": "订单已取消",
        "skip_reason_canceled": "订单已取消",
        "skip_reason_rejected": "订单被拒绝",
        "skip_reason_inactive": "订单未激活",
        "skip_reason_error": "下单出错",
        "skip_reason_api_cancelled": "API 已取消",
        "skip_reason_target_diff_below_threshold": "调仓差异低于阈值",
        "skip_reason_pending_sell_release": "需先减仓但未卖出，避免融资本轮跳过",
        "skip_reason_negative_cash": "账户现金为负，避免额外融资",
        "skip_order_detail": "{symbol}（{reason}）",
        "skip_order_detail_with_qty": "{symbol} {quantity}（{reason}）",
        "no_equity": "暂未持仓，等待建仓",
        "signal_label": "信号",
        "signal_short_label": "信号方向",
    ...
    "en": {
        ...
        "deferred_buy_batch": "ℹ️ [Buy skipped] {details}",
        "deferred_sell_batch": "ℹ️ [Sell skipped] {details}",
        "failed_buy_batch": "❌ [Buy failed] {details}",
        "failed_sell_batch": "❌ [Sell failed] {details}",
        "skip_reason_quantity_zero": "whole-share quantity rounds to 0; no order needed",
        "skip_reason_min_notional": "below minimum order notional",
        "skip_reason_missing_price": "missing valid quote",
        "skip_reason_submit_failed": "submit failed",
        "skip_reason_below_trade_threshold": "below rebalance threshold",
        "skip_reason_unknown": "unknown reason",
        "skip_reason_cancelled": "order cancelled",
        "skip_reason_canceled": "order canceled",
        "skip_reason_rejected": "order rejected",
        "skip_reason_inactive": "order inactive",
        "skip_reason_error": "order error",
        "skip_reason_api_cancelled": "cancelled by API",
        "skip_reason_target_diff_below_threshold": "rebalance gap below threshold",
        "skip_reason_pending_sell_release": "sell release pending; buy skipped to avoid margin",
        "skip_reason_negative_cash": "account cash is negative; buy skipped to avoid margin",
        "skip_order_detail": "{symbol} ({reason})",
        "skip_order_detail_with_qty": "{symbol} {quantity} ({reason})",
        "no_equity": "No position yet — waiting to build",
        "signal_label": "Signal",
        "signal_short_label": "Signal Direction",
